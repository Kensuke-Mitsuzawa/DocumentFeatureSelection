...
class DataConverter(object):
    ...
    def labeledMultiDocs2Matrix(self, labeled_documents, ngram=1, n_jobs=1):
        ...
        set_document_information = labeledMultiDocs2labeledDocsSet.multiDocs2SetDocs(labeled_documents)
