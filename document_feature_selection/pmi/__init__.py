...
def get_pmi_score(labeled_structure, logger, ngram=1, outformat='items'):
    csr_matrix, label_group_dict, vocabulary = make_pmi_matrix(labeled_structure, logger, ngram)
    pmi_score_objects = pmi_single_process_main(csr_matrix, vocabulary, label_group_dict, logger, outformat=outformat)
